...
void GameCubeControllerSimulationDataGenerator::Initialize(
  U32 simulation_sample_rate, GameCubeControllerAnalyzerSettings* settings) {
...
U32 GameCubeControllerSimulationDataGenerator::GenerateSimulationData(
